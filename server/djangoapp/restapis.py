...
def get_dealer_from_cf_by_id(url, id):
    print("get_dealer_from_cf_by_id")
    print(url)
    print(id)
...
def analyze_review_sentiments(dealer_review):
    API_KEY = "I3nwCj3hPKm2dQFE4QZEeUMCbrtJzuRtUZJeLFf26mL5"
    NLU_URL = 'https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/f137493e-2db1-46b5-91a1-ea64bcafbe08'
